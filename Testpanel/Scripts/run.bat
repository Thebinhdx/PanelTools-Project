@echo off
set version=3.1
set sversion=2.9910.1_RELEASETEST
...
cls
cls
title Testpaneltools V%version%
...
echo Version Batch File: %version% [%sversion%]
goto menu
...
echo:
echo       [32] OBS Studio       [34] 7-Zip               [44] Malwarebytes            [54] Driver Booster
echo:
echo       [33] Bandicam         [35] AnyDesk             [45] MSI Afterburner         [55] Capcut
echo:
echo                             [36] CPU-Z               [46] Nilesoft Shell          [56] IObit Uninstaller
echo:
echo                             [37] Crystal Disk        [47] OPAutoClicker           [57] NVIDIA App
echo:
...
echo:
echo                             [42] JDownloader         [52] Java                    [0] Exit
echo:
...
echo Example: From mssstore: 9NF8H0H7WMLT [ID NVIDIA Control Panel]
...
if "%options7%"=="1" goto nvixp
if "%options7%"=="2" goto nvinow
if "%options7%"=="0" goto next2
