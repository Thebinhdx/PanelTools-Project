@echo off
set version=3.8 BETA 1
set sversion=3.7299.2_BETA
...
echo:
echo            [3] Tweaks [Beta]             =============-About-============
echo:
echo    [4] Activate Windows and Office [*]   -Name: PanelTools
...
echo:
echo =============================================================================
echo        -If you are in this situation, you should choose the first one-
echo:
